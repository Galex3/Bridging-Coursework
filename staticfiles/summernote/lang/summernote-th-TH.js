...
,
    ...
    :
        'Change current block\'s format as a paragraph(P tag)',
            'formatH1'
    :
        'เปลี่ยนรูปแบบบล็อคปัจจุบันเป็น H1',
            'formatH2'
    :
        'เปลี่ยนรูปแบบบล็อคปัจจุบันเป็น H2',
            'formatH3'
    :
        'เปลี่ยนรูปแบบบล็อคปัจจุบันเป็น H3',
            'formatH4'
    :
        'เปลี่ยนรูปแบบบล็อคปัจจุบันเป็น H4',
            'formatH5'
    :
        'เปลี่ยนรูปแบบบล็อคปัจจุบันเป็น H5',
            'formatH6'
    :
        'เปลี่ยนรูปแบบบล็อคปัจจุบันเป็น H6',
